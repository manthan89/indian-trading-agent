      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {strategies.map((strategy) => (
          <Link key={strategy.id} href={strategy.href}>
            <Card className={`h-full hover:shadow-md transition-all cursor-pointer group ${strategy.borderColor}`}>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-3 flex-wrap">
                      {strategy.tags.map((tag) => <Badge key={tag} variant="outline" className="text-xs">{tag}</Badge>)}
